...
(() => {
  ...
  function mount(){
    ...
    style.textContent+=`
      /* Explicit positioning also overrides CSS resets applied to native dialogs. */
      #qn-dialog{position:fixed;inset:0;margin:auto;width:min(810px,calc(100vw - 32px));max-width:810px;height:fit-content;max-height:calc(100dvh - 32px);padding:28px;border:0;border-radius:28px;background:#fff;color:#0f172a;overflow-y:auto;overscroll-behavior:contain;box-sizing:border-box;box-shadow:0 24px 80px #082f4940}
      #qn-dialog::backdrop{background:#12384da6}
      #qn-dialog>form{display:flex;justify-content:flex-end;margin-bottom:14px}
      #qn-dialog>form button{min-height:48px;padding:12px 22px;font-size:16px}
      #qn-dialog-body{min-width:0;overflow-wrap:anywhere}
      #qn-dialog-body .qj-ar,#qn-dialog-body .qn-big{font-size:clamp(54px,8vw,84px);text-align:center;margin:22px 0 12px;line-height:2}
      #qn-dialog-body .qj-roman,#qn-dialog-body .qn-model{font-size:clamp(26px,4vw,36px);text-align:center;margin:12px 0 24px}
      #qn-dialog-body .qj-detail>p:not(.qj-ar):not(.qj-roman):not(.qj-label):not(.qj-muted){margin:12px 0}
      body{height:100dvh}main{min-width:0}#qaida-journey{min-width:0}.qj-card{min-width:0;overflow-x:auto}.qj-grid{min-width:calc(var(--qj-columns)*48px)}.qj-shapes .qj-grid{min-width:0}.qj-stage summary{overflow-wrap:anywhere}.qj-line button{max-width:100%}.qj-resume>div{min-width:0}.qj-header h2{overflow-wrap:anywhere}
      @media(max-width:767px){#mobile-menu{padding-bottom:max(24px,env(safe-area-inset-bottom));overscroll-behavior:contain}#qn-dialog{width:calc(100vw - 24px);max-height:calc(100dvh - 24px);padding:18px;border-radius:22px}#qn-dialog>form{position:sticky;top:-18px;background:#fff;z-index:1;padding:6px 0}#qn-dialog-body .qj-ar{font-size:clamp(44px,12vw,64px)}#qn-dialog-body .qj-roman{font-size:26px}.qj-resume{align-items:stretch}.qj-resume>.qj-button{width:100%}.qj-actions{gap:8px}.qj-actions>.qj-button{flex:1 1 auto;margin-right:0}.qj-card{border-radius:16px}.qj-breakdown{font-size:24px}.qj-line{line-height:2.3}#qaida-journey .qj-detail .qj-ar{font-size:clamp(34px,9vw,54px)}.qj-shapes .qj-cell span{font-size:25px}}
    `;
