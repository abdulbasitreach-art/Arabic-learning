...
Extract the ZIP, then choose **File → Open Folder** in Cursor and select the extracted folder. Open `index.html` in a browser to use the app. Keep both `foundation-lessons.js` and `qaida-next-lessons.js` beside `index.html`.
...
3. Upload `index.html`, `foundation-lessons.js`, `qaida-next-lessons.js` and `README.md` from this folder, then commit.
